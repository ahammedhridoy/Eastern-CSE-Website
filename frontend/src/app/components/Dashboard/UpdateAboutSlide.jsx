...
const UpdateAboutSlide = ({ slide, handleUpdateClose }) => {
  const [image, setImage] = useState(null);
  const { updateAboutSlide } = useContext(GlobalContext);
  ...
  const handleUpdate = async (e) => {
    ...
    const success = await updateAboutSlide(slide?.id, formData);
...
export default UpdateAboutSlide;
